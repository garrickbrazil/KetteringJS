...
*/
var KU={}
!function(t){function e(t){for(var e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i="NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm0123456789",r=[],s="",n=0;n<=e.length;n++)r[e.substr(n,1)]=i.substr(n,1)
...
$.ajax({url:r,type:"GET",dataType:"html",success:function(i){var r=$("<div>").html(i),s=function(t){return t.text().trim().toLowerCase()},n=/[a-zA-Z]+\s+\d\d\d\d/,a=/\$0+(\.0+)?/,o="0",l=[],d=[],c="",h="",u="",m="",f="",p="",v="",g=""
$(".datadisplaytable",r).find("tr").each(function(){if(1==$("th",this).size()&&1==$("td",this).size()){var t=s($("th",this).eq(0)),i=$("td",this).eq(0).text().trim()
"account balance:"===t?o=i:"term charges:"===t?h=i:"term credits and payments:"===t?u=i:"term balance:"===t&&(m=i,l[l.length]=new e.JWEB.AccountTerm(c,h,u,m,d),d=[],c="",h="",u="",m="",f="",p="",v="",g="")}else if(1==$("th",this).size()&&0==$("td",this).size()){var t=$("th",this).eq(0).text().trim()
n.test(t)&&(c=t)}else 5==$("td",this).size()?(p=$("td",this).eq(0).text().trim(),v=$("td",this).eq(1).text().trim(),charge=$("td",this).eq(2).text().trim(),credit=$("td",this).eq(3).text().trim(),g=""==charge?credit:a.test(charge)?charge:"-"+charge,d[d.length]=new e.JWEB.AccountEntry(p,v,g)):5==$("td",this).size()&&(p=$("td",this).eq(0).text().trim(),v=$("td",this).eq(1).text().trim(),charge=$("td",this).eq(2).text().trim(),credit=$("td",this).eq(3).text().trim(),g=""==charge?credit:a.test(charge)?charge:"-"+charge,d[d.length]=new e.JWEB.AccountEntry(p,v,g))}),t(o,l)},error:function(t,e,r){i(r)}})},retrieveCurrentHolds:function(t,e){var i="http://jweb.kettering.edu/cku1/bwskoacc.P_ViewHold"
...
if(17==t.size()){var i="",r="",n="",a="",o="",l="",d="",c="",h="",u="",m="",f="",p="",v=""
i=t.eq(0).text().trim(),r=t.eq(1).text().trim(),n=t.eq(2).text().trim()+"-"+t.eq(3).text().trim(),a=t.eq(4).text().trim(),o=t.eq(5).text().trim(),l=t.eq(6).text().trim(),d=t.eq(7).text().trim(),c=t.eq(8).text().trim(),h=t.eq(9).text().trim(),u=t.eq(10).text().trim(),m=t.eq(11).text().trim(),f=t.eq(13).text().trim(),p=t.eq(14).text().trim(),v=t.eq(15).text().trim(),s[s.length]=new e.JWEB.CatalogEntry(i,r,n,a,o,l,d,c,h,u,m,f,p,v)}}),i(s)},error:function(t,e,i){r(i)}})},retrieveScheduleTerms:function(t,e){var i="https://jweb.kettering.edu/cku1/bwskflib.P_SelDefTerm"
...
var t=children.eq(0).text().trim(),i=children.eq(1).text().trim()+"-"+children.eq(2).text().trim(),r=children.eq(3).text().trim(),d=children.eq(4).text().trim(),c=children.eq(5).text().trim(),h=children.eq(6).text().trim(),u=children.eq(8).text().trim()
l[l.length]=new e.JWEB.FinalGrade(t,i,r,d,c,h,u)}1==$("th",this).size()&&5==$("td",this).size()&&(label=s($("th",this).eq(0)),gpaInfo=$("td",this).eq(4).text().trim(),"current term:"===label&&(a=gpaInfo),"overall:"===label&&(o=gpaInfo))})}),i(n,a,o,l)},error:function(t,e,i){r(i)}})},generateEvaluation:function(t,e,i,r,s){var n="https://jweb.kettering.edu/cku1/bwckcapp.P_Submit?source1="+t+"&program="+e+"&ctlg_term="+i+"&eval_term=999999&dflt_ip=Y"
...
i.details=N,L[L.length]=i}M=[],B="",S="",A="",P="",z="",G="",U="",N="",R=groups[1],_=groups[2],O="Met"==groups[3]}else if(17==$("td",this).size()){children=$("td",this)
...
for(var t in M){var i=M[t]
i.details=N,L[L.length]=i}M=[],B="",S="",A="",P="",z="",G="",U="",N="",J=children.eq(1).text().trim(),D=children.eq(2).text().trim()}}),""!=R&&(I[I.length]=new e.JWEB.EvalArea(O,R,_,J,D,L))}evaluation=new e.JWEB.Evaluation(p,v,o,l,d,c,h,a,u,m,f,b,_,w,y,q,T,E,k,I),r(evaluation)},error:function(t,e,i){s(i)}})},error:function(t,e,i){s(i)}})},retrieveEvaluationList:function(t,e,i){var r="https://jweb.kettering.edu/cku1/bwcksmmt.P_DispPrevEval?term_in="+t
...
$.ajax({url:r,type:"GET",dataType:"html",success:function(t){for(var i=$("<div>").html(t),r=$("table.datadisplaytable",i),s=[],n=0;n+1<r.size();n+=2){var a,o,l,d,c,h,u,m,f,p,v,g,x=r.eq(n),b=r.eq(n+1)
courseTitlePattern=/(.*)\s-\s(.*\s.*)\s-\s(\d\d)/
var _=function(t){return t.text().trim().toLowerCase()}
if(courseTitlePattern.test(x.find("caption:first").text().trim())){var w=courseTitlePattern.exec(x.find("caption:first").text().trim())
if(a=w[1],o=w[2].replace(" ","-"),l=w[3],d="",c="",h="",u="",m="",$("tbody tr",x).each(function(){1==$("th",this).size()&&1==$("td",this).size()&&("associated term:"===_($("th",this))?d=$("td",this).text().trim():"crn:"===_($("th",this))?c=$("td",this).text().trim():"assigned instructor:"===_($("th",this))?h=$("td",this).text().trim():"credits:"===_($("th",this))?u=$("td",this).text().trim():"campus:"===_($("th",this))&&(m=$("td",this).text().trim()))}),f="",p="",v="",g="",b.find("tr").size()>1){var y=b.find("tr").eq(0),q=b.find("tr").eq(1)
y.find("th").size()==q.find("td").size()&&$("th",y).each(function(t){"schedule type"===_($(this))?f=$("td",q).eq(t).text().trim():"time"===_($(this))?p=$("td",q).eq(t).text().trim():"days"===_($(this))?v=$("td",q).eq(t).text().trim():"where"===_($(this))&&(g=$("td",q).eq(t).text().trim())})}s[s.length]=new KU.Student.JWEB.Course(a,o,l,d,c,h,u,m,f,p,v,g)}}e(s)},error:function(t,e,r){i(r)}})}},e.BB={Contact:function(t,e,i){this.firstName=t,this.lastName=e,this.email=i},Grade:function(t,e,i,r,s,n,a){this.title=t,this.grade=e,this.pointsPossible=i,this.dueDate=r,this.postedDate=s,this.status=n,this.additionalInfo=a},Tree:function(t,e,i,r){return this.bbId=t,this.contentId=e,this.folders=i,this.items=r,this},Folder:function(t,i,r,s){return this.bbId=t,this.contentId=i,this.name=r,this.details=s,this.getContentTree=function(t,i){e.BB.retrieveContentTree(this.bbId,this.contentId,t,i)},this},Item:function(t,e,i){return this.name=t,this.details=e,this.fullBBId=i,this},Course:function(t,i,r,s,n,a,o,l){return this.courseId=t,this.term=i,this.crn=r,this.section=s,this.courseTitle=n,this.days=a,this.time=o,this.bbId=l,this.getContentTree=function(t,i){e.BB.retrieveContentTree(this.bbId,"",t,i)},this.getRoster=function(t,e){KU.Student.BB.retrieveRoster(this.bbId,t,e)},this.getGrades=function(t,e){KU.Student.BB.retrieveGrades(this.bbId,t,e)},this},retrieveGrades:function(t,i,r){var s="https://kettering.blackboard.com/webapps/bb-mygrades-BBLEARN/myGrades?course_id="+t+"&stream_name=mygrades"
$.ajax({url:s,type:"GET",dataType:"html",success:function(t){var r=$("<div>").html(t),s=[]
...
var _=/.*folder_on.*/,w=/.*document_on.*/,y=/.*textbookLogo.*/,q=/contentListItem:(_\d\d+_\d+)/,T=$(".courseId",b).text()
...
_.test(i)?n[n.length]=new e.BB.Folder(t,r,s,a):w.test(i)||y.test(i)?l[l.length]=new e.BB.Item(s,a,T):0==$("> img",this).size()&&(l[l.length]=new e.BB.Item(s,a,T))}})}d=new e.BB.Tree(t,o,n,l),r(d)},error:function(t,e,i){s(i)}})},logout:function(t,i){var r="https://kettering.blackboard.com/webapps/login?action=logout"
...
o.sort(l)
for(var c=0;c<o.length;c++){var h,u,m,f,p,v,g,$,x,b,_=o[c]
u=t.toUpperCase()+"-"+r,m=_.course,f=_.course_title,g=_.college,$=_.college_code,x=_.course_city,b=_.course_state,v=new e(g,$,x,b),d[c]=new i(h,u,m,f,p,v)}s=null,a(d)},error:function(t,e,i){s=null,"abort"!=e&&o(i)}})},r.getColleges=function(t,i){var r="https://okras.kettering.edu/kuapps/apex_apps.transfer_art_pkg.get_json_ces_colleges",s=[]
