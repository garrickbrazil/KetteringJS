...
*/
var KU={KetteringJS:{version:"v0.0.8",updated:"7/26/2015",name:"KetteringJS",license:"GPL3"}}
...
for(var I=[],j=/([a-zA-Z\s]+)\s*\(\s*(\d+\.\d+)\scredits\s*\)\s*-\s*(.*)/,B=2;B<i.find("table.datadisplaytable").size();B++){var C="",S="",P="",A="",U="",z="",G="",N="",R="",J="",w="",O="",W="",K=[],D=[]
i.find("table.datadisplaytable").eq(B).find("tr").each(function(){if(1==$("th",this).size()&&1==$("td",this).size()&&j.test($("td",this).eq(0).text().trim())){groups=j.exec($("td",this).eq(0).text().trim())
for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",J=groups[1],w=groups[2],R="Met"==groups[3]}else if(17==$("td",this).size()){children=$("td",this)
...
for(var t in D){var i=D[t]
i.details=G,K[K.length]=i}D=[],C="",S="",P="",A="",U="",z="",N="",G="",O=children.eq(1).text().trim(),W=children.eq(2).text().trim()}}),""!=J&&(I[I.length]=new e.JWEB.EvalArea(R,J,w,O,W,K))}evaluation=new e.JWEB.Evaluation(p,v,o,l,d,c,h,a,u,m,f,b,w,_,y,q,E,T,k,I),r(evaluation)},error:function(t,e,i){s(i)}})},error:function(t,e,i){s(i)}})},retrieveEvaluationList:function(t,e,i){var r="https://jweb.kettering.edu/cku1/bwcksmmt.P_DispPrevEval?term_in="+t
