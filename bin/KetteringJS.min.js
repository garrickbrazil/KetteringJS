...
r[t]=new n(i,e)}),t(r)},error:function(t){e(t)}})},t.Directory=i}(KU),function(t){function e(t,e){return Object.defineProperty(this,"title",{get:function(){return t},set:function(){}}),Object.defineProperty(this,"mainHtml",{get:function(){return e},set:function(){}}),this}function n(t,n,r,i,o,s,u,c,a){var f=null
return Object.defineProperty(this,"title",{get:function(){return t},set:function(){}}),Object.defineProperty(this,"location",{get:function(){return n},set:function(){}}),Object.defineProperty(this,"time",{get:function(){return r},set:function(){}}),Object.defineProperty(this,"month",{get:function(){return i},set:function(){}}),Object.defineProperty(this,"dayOfTheMonth",{get:function(){return o},set:function(){}}),Object.defineProperty(this,"dayOfTheWeek",{get:function(){return s},set:function(){}}),Object.defineProperty(this,"tags",{get:function(){return u},set:function(){}}),Object.defineProperty(this,"imgUrl",{get:function(){return c},set:function(){}}),this.getEvent=function(t,n){if(null!=f)return void t(f)
var r="http://www.kettering.edu/"+a
$.ajax({url:r,type:"GET",dataType:"html",success:function(n){var r=$("<div>").html(n),i=r.find(".content.clearfix"),o=r.find(".title.inside").text(),s=new e(o,i)
t(s)},error:function(t,e,r){n(r)}})},this}var r={},i=null
r.retrieve=function(t,e,r){var o
...
return this.getArticle=function(t,n){if(null!=s)return void t(s)
var r="http://www.kettering.edu/"+o
$.ajax({url:r,type:"GET",dataType:"html",success:function(n){var r=$("<div>").html(n),i=r.find(".field.field-name-body.field-type-text-with-summary.field-label-hidden"),o=r.find(".news").text(),s=r.find(".info").text(),u=new e(o,s,i)
t(u)},error:function(t,e,r){n(r)}})},Object.defineProperty(this,"title",{get:function(){return t},set:function(){}}),Object.defineProperty(this,"author",{get:function(){return n},set:function(){}}),Object.defineProperty(this,"date",{get:function(){return r},set:function(){}}),Object.defineProperty(this,"imgUrl",{get:function(){return i},set:function(){}}),this}var r={},i=null
r.retrieve=function(t,e,r){var o
...
s.sort(c)
for(var a=0,f=0;f<s.length;f++){var l,h,d,p,g,v,y,m,b,_,w=s[f]
"Y"==w.transferableflag&&(l=w.kucoursetitle.trim(),h=w.kucourse.trim(),d=w.trnscrse.trim(),p=w.trnscrsetitle.trim(),g=w.credits.trim(),y=w.institution.replace(t,"").trim(),m=t,v=new e(y,m,b,_),u[a++]=new n(l,h,d,p,g,v))}i=null,r(u)},error:function(t,e,n){i=null,"abort"!=e&&o(n)}})},r.searchByCourseId=function(t,r,o,s,u){var c="https://okras.kettering.edu/kuapps/apex_apps.transfer_art_pkg.get_json_transferable_courses?as_state=ALL&as_subject="+encodeURIComponent(t.toUpperCase())+"&as_course="+encodeURIComponent(r),a=[]
...
u.sort(c)
for(var f=0;f<u.length;f++){var l,h,d,p,g,v,y,m,b,_,w=u[f]
h=t.toUpperCase()+"-"+r,d=w.course,p=w.course_title,y=w.college,m=w.college_code,b=w.course_city,_=w.course_state,v=new e(y,m,b,_),a[f]=new n(l,h,d,p,g,v)}i=null,s(a)},error:function(t,e,n){i=null,"abort"!=e&&u(n)}})},r.getColleges=function(t,n){var r="https://okras.kettering.edu/kuapps/apex_apps.transfer_art_pkg.get_json_ces_colleges",i=[]
