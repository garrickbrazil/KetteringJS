...
o.abort=function(){null!=u&&(u.abort(),u=null)},o.search=function(t,n,o,c,a,f,l){if(void 0==l)var l=0
if(null!=u)return void f("One search is already occurring. Please cancel first.")
s={page:l,firstName:t,lastName:n,ext:o,departmentId:c}
var d="http://www.kettering.edu/faculty-staff/directory?field_faculty_staff_first_value="+encodeURIComponent(t)+"&field_faculty_staff_last_value="+encodeURIComponent(n)+"&field_phone_extension_value="+o+"&tid="+c+"&page=0"+l
u=$.ajax({url:d,type:"GET",dataType:"html",success:function(t){var n=[],o=$("<div>").html(t).find(".directory-caption")
